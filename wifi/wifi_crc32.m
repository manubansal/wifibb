function [crc_val crcValid] = wifi_crc32(msg)
  ...
  %crc_comparison = [computed_crc computed_crc_v2  computed_crc-computed_crc_v2]% computed_crc_ti]
  %pause

  %crc_val = computed_crc;
  %crcValid = sum(computed_crc == rx_crc_bin_lin) == 32;
  crc_val = computed_crc_v2;
  crcValid = sum(computed_crc_v2 == rx_crc_bin_lin) == 32;
end
